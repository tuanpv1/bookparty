...
<div class="form-body">
    ...
    <?= $form->field($model, 'image')->widget(\kartik\file\FileInput::classname(), [
        'pluginOptions' => [
            ...
            'initialPreview' => $avatarPreview ? [
                Html::img(Yii::getAlias('@web') . '/' . Yii::getAlias('@image_group') . "/" . $model->image, ['class' => 'file-preview-image', 'style' => 'width: 100%;']),
    ...
    <?= $form->field($model, 'status')->dropDownList(['Chọn trạng thái'=>Food::getListStatus()]) ?>
